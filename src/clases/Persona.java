...
public class Persona {
	private String numeroDeDNI;
	   ...
	   public void registrarDatos() {	   
	        numeroDeDNI = validarDato1("Ingrese el número de documento");
	        nombre = validarDato1("Ingrese el nombre");
	        apellido = validarDato1("Ingrese el apellido");
	        fechaDeNacimiento = validarDato1("Ingrese la fecha de nacimiento");
	        direccion = validarDato1("Ingrese la dirección");
	        ciudadDeProcedecia = validarDato1("Ingrese la ciudad de procedencia");
	    ...
	    private  String validarDato1(String mensaje) {
